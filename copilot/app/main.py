...
try:
    with open("/code/configs/smith_config.json") as config_file:
...
langchain_tracing_v2 = config.get("LANGCHAIN_TRACING_V2", "false") 
langchain_api_key = config.get("LANGCHAIN_API_KEY", "")
openai_api_key = config.get("OPENAI_API_KEY", "")


if isinstance(langchain_tracing_v2, bool):
    langchain_tracing_v2 = str(langchain_tracing_v2).lower()  
